...
export function Footer() {
  return (
    <footer className="relative z-10 w-full border-t border-border/20 bg-background/80 backdrop-blur-sm">
      <div className="container mx-auto flex h-16 flex-col items-center justify-between gap-4 px-4 text-center md:flex-row md:px-6">
